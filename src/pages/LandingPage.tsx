        ...
        <div className="grid gap-10 lg:grid-cols-[1.2fr_1fr]">
          <div>
            ...
            <p className="mt-3 text-[13px] leading-relaxed text-[var(--color-text-secondary)]">
              Console, TUI, companion, and living orrery all paint from one token registry. Nine skins
              (including soft Everforest Light) swap colors and fonts at runtime. Flat surfaces,
