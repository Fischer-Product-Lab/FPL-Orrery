 ...
 session store (Zustand)
      ...
      <section className="space-y-3">
        ...
        <p className="text-[12px] leading-relaxed text-[var(--color-text-tertiary)]">
          ...
          orrery. Theme system: seventeen skins from one TypeScript token registry (Observatory first,
          then alphabetical: Andromeda, Aura Spirit Dracula, Kanagawa Dragon, Vesper, and the rest).
          Colors and fonts apply as CSS custom properties; the canvas recolors
