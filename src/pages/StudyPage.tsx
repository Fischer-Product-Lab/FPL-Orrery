 ...
 session store (Zustand)
      ...
      <section className="space-y-3">
        ...
        <p className="text-[12px] leading-relaxed text-[var(--color-text-tertiary)]">
          ...
          orrery. Theme system: sixteen skins from one TypeScript token registry (Observatory through
          Everforest Light, including Andromeda, Aura Spirit Dracula, Dracula Redefined, Neon City,
          Catppuccin, Gruvbox, and Deep Dark Space). Colors and fonts apply as CSS custom properties; the canvas recolors
